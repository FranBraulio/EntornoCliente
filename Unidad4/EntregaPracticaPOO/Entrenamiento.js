...
class Motos extends Vehiculo{
    constructor(brand, model, manufacturingYear, price, tipoDeManillar ){
        super(brand, model, manufacturingYear, price);
    ...
    mostrarInfo(){
        return `${super.mostrarInfo()} tipo de manillar ${this.tipoDeManillar}`;
    }
}
...
const moto1 = new Motos("Yamaha", "MT-07", 2021, 7500, "tracker");
...
const moto2 = new Motos("Harley-Davidson", "Iron 883", 2019, 9000, "cruiser");
